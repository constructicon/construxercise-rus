...
function Ex5_eng() {
    result = "Connect the phrases by choosing the matching continuation. Use the construction <span class='construction'>С одной стороны, XP/Cl. С другой (стороны), XP/Cl</span>&#39;On the one hand, ... On the other hand, ...&#39;. The word «стороны» in the second part of this construction is often omitted, therefore in the formula of this construction this word is placed in parentheses ()."
...
function Ex5_norw() {
    result = "Fullfør setningene ved å velge delene som passer sammen. Bruk konstruksjonen <span class='construction'>С одной стороны, XP/Cl. С другой (стороны), XP/Cl</span>&#39;På den ene siden, ... På den andre siden, ...&#39;. I denne konstruksjonens andre halvdel er ofte ordet «стороны» utelatt, derfor står den i parenteser i formelen."
...
function Ex7_eng() {
    result = "Make a short story about how each of the following friends spent their day. Evaluate whether the day went well by using the construction <span class='construction'>в целом, Cl</span> &#39;overall, ...&#39;.You see an entry in a diary. Connect the matching sentences by using the indicated constructions."
...
function Ex7_norw() {
    result = "Lag en kort fortelling om en dag i livet til en av vennene. Beskriv hvordan dagen var ved hjelp av konstruksjonen <span class='construction'>в целом, Cl</span> &#39;alt i alt, ...&#39;."
...
function Ex12_eng() {
    result = "Bonus exercise. Connect the tourist attractions in Russia (1-4) with the facts about them (а-г). Use the construction <span class='construction'>что касается NP-Gen, то Cl</span> &#39;concerning ..., ...&#39;."
...
function Ex12_norw() {
    result = "Bonusoppgave. Koble sammen Russlands severdigheter (1-4) med faktaene som passer (а-г). Bruk konstruksjonen <span class='construction'>что касается NP-Gen, то Cl</span> &#39;når det gjelder ..., ...&#39;."
